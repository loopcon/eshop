                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/banner/add_banner'); ?>" method="POST" id="add_product_form" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="banner_input_name" placeholder="Banner Name" name="banner_input_name" value="<?= isset($fetched_data[0]['name'])?output_escaping($fetched_data[0]['name']):"" ?>">
                                    </div>
                                </div>
