                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" id="update-language-form" action="<?= base_url('admin/language/save'); ?>" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="register_as_seller" class="control-checkbox">Register as seller</label>
                                            <input type="text" name="register_as_seller" class="form-control" value="<?= (isset($lang_labels['register_as_seller']) && !empty($lang_labels['register_as_seller'])) ? $lang_labels['register_as_seller'] : 'Register as seller'; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="login_as_seller" class="control-checkbox">Login as seller</label>
                                            <input type="text" name="login_as_seller" class="form-control" value="<?= (isset($lang_labels['login_as_seller']) && !empty($lang_labels['login_as_seller'])) ? $lang_labels['login_as_seller'] : 'Login as seller'; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="store_url" class="control-checkbox">Store URL</label>
                                            <input type="text" name="store_url" class="form-control" value="<?= (isset($lang_labels['store_url']) && !empty($lang_labels['store_url'])) ? $lang_labels['store_description'] : 'Store URL'; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="store_logo" class="control-checkbox">Store Logo</label>
                                            <input type="text" name="store_logo" class="form-control" value="<?= (isset($lang_labels['store_logo']) && !empty($lang_labels['store_logo'])) ? $lang_labels['store_description'] : 'Store Logo'; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="latitude" class="control-checkbox">Latitude</label>
                                            <input type="text" name="latitude" class="form-control" value="<?= (isset($lang_labels['latitude']) && !empty($lang_labels['latitude'])) ? $lang_labels['latitude'] : 'Latitude'; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="longitude" class="control-checkbox">Longitude</label>
                                            <input type="text" name="longitude" class="form-control" value="<?= (isset($lang_labels['longitude']) && !empty($lang_labels['longitude'])) ? $lang_labels['longitude'] : 'Longitude'; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="other_details" class="control-checkbox">Other Details</label>
                                            <input type="text" name="other_details" class="form-control" value="<?= (isset($lang_labels['other_details']) && !empty($lang_labels['other_details'])) ? $lang_labels['other_details'] : 'Other Details'; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
