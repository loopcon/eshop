        ...
        <div class="row mb-5">
            ...
            <div class="col-md-8 col-12 row">
                ...
                <?php if($login_type=='vendor') { ?>
                    <div class='col-md-3 card text-center border-0 mr-3 mb-3'>
                        <a href='<?=base_url('my-account/store-details') ?>' class="link-color">
                            <div class='card-header bg-transparent'>
                                <?= !empty($this->lang->line('store_details')) ? $this->lang->line('store_details') : 'STORE DETAILS' ?>
                            </div>
                            <div class='card-body'>
                                <i class="fa fa-store dashboard-icon link-color fa-lg"></i>
                            </div>
                        </a>
                    </div>
                    <div class='col-md-3 card text-center border-0 mr-3 mb-3'>
                ...
                <?php if($login_type=='customer' || ($login_type=='vendor' && $status==1)) { ?>
                    <div class='col-md-3 card text-center border-0 mr-3 mb-3'>
                        <a href='<?= base_url('my-account/favorites') ?>' class="link-color">
                            <div class='card-header bg-transparent'>
