            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        <!-- form start -->
                        <form class="form-horizontal form-submit-event" action="<?= base_url('seller/attributes/add_attributes'); ?>"  method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-info">
                                        <!-- form start -->
                                        <form class="form-horizontal form-submit-event" action="<?= base_url('seller/attribute_set/add_attribute_set'); ?>" method="POST" enctype="multipart/form-data">
                                            <div class="card-body">
                                                <?php if (isset($fetched_data[0]['id'])) { ?>
                                    ...
                                    <div class="card content-area p-4">
                                        ...
                                        <div class="card-innr">
                                            ...
                                            <table class='table-striped' id='category_table'
                                                ...
                                                data-export-options='{"fileName": "attribute-set-list", "ignoreColumn": ["state"]}'
